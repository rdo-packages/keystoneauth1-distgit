...
%check
PYTHON=python%{pyver} stestr-%{pyver} run --black-regex '.*test_invalidate_response'
...
%changelog
* Tue Jun 08 2021 RDO <dev@lists.rdoproject.org> 3.17.4-1
- Update to 3.17.4

* Mon Jul 13 2020 RDO <dev@lists.rdoproject.org> 3.17.3-1
- Update to 3.17.3
